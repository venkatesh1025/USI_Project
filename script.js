    ...
    let data = [
      {
        ...
        "Detect Version Command":
          'snap list | grep -oP "(?<=intellij-idea-community  )[^ ]+"',
      ...
      },
      {
        ...
        "Test Result": "PASSED",
        "Detect Version Command":
          'snap list | grep -oP "(?<=pycharm-community        )[^ ]+"',
      ...
      },
      {
        ...
        "Test Result": "PASSED",
        "Detect Version Command":
          'azcopy -v | grep -oP "(?<=azcopy version )[^ ]+"',
      ...
      },
      {
        ...
        "Test Result": "PASSED",
        "Detect Version Command":
          'nvidia-smi | grep -oP "(?<=CUDA Version: )[^ ]+"',
      ...
      },
      {
        ...
        "Test Result": "PASSED",
        "Detect Version Command":
          'docker --version | grep -oP "(?<=Docker version )[0-9. ]+"',
      ...
      },
      {
        ...
        "Test Result": "PASSED",
        "Detect Version Command":
          'emacs --version | grep -oP "(?<=GNU Emacs )[0-9. ]+"',
      ...
      },
      {
        ...
        "Test Result": "PASSED",
        "Detect Version Command":
          ' git --version | grep -oP "(?<=git version )[^ ]+"',
      ...
      },
      {
        ...
        "Test Result": "PASSED",
        "Detect Version Command":
          'nvidia-smi | grep -oP "(?<=Driver Version: )[^ ]+"',
      ...
      },
      {
        ...
        "Test Result": "PASSED",
        "Detect Version Command":
          'rstudio-server version | grep -Eo "[0-9]+\\.[0-9]+\\.[0-9]+"',
      ...
      },
      {
        ...
        "Test Result": "PASSED",
        "Detect Version Command":
          'spark-submit --version 2>tmp && cat tmp | grep -oP "(?<=version )[^ ]+" |tail -n 1',
      ...
      },
      {
        ...
        "Test Result": "PASSED",
        "Detect Version Command":
          'spark-submit --version 2>tmp && cat tmp | grep -oP "(?<=version )[^ ]+" | head -n 1',
        "Test Command": "spark-submit --version",
      },
      {
        Software: "VS Code",
      ...
      },
      {
        ...
        "Test Result": "PASSED",
        "Detect Version Command":
          "cat /usr/include/cudnn_version.h | grep -oP \"(?<= CUDNN_MAJOR | CUDNN_MINOR | CUDNN_PATCHLEVEL )[0-9.]+\" | awk '{print}' ORS='.'",
      ...
      },
      {
        ...
        "Test Result": "PASSED",
        "Detect Version Command":
          'nano --version|grep -oP "(?<=version )[^ ]+"',
        "Test Command": "nano --version",
      },
    ];

    for (var i = 0; i < data.length; i++) {
      if (searchInput == data[i].Version) {
